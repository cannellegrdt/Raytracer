 ...
 * File description: Directional light source that illuminates from a constant direction.
 */
...
public:
    ...
    DirectionalLight(const Vec3 &direction, const Color &color, double intensity) : _direction(normalize(direction)), _color(color), _intensity(intensity) {};
