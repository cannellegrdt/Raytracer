...
Test(camera, generate_ray_origin_is_camera_position) {
    ...
    Ray ray = cam.generateRay(320, 240);
...
Test(camera, aspect_ratio_affects_horizontal_spread) {
    ...
    Ray rayWide = camWide.generateRay(199, 99);
    Ray rayTall = camTall.generateRay(99, 199);
...
Test(camera, different_fov_produces_different_directions) {
    ...
    Ray ray60 = cam60.generateRay(99, 99);
    Ray ray120 = cam120.generateRay(99, 99);
