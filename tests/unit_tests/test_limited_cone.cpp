 ...
 * Description: Criterion unit tests for the LimitedCone plugin - configure validation and ray intersection.
 *
 * limited_cone.cpp is included directly (not linked as .so) so we can test the class in isolation.
